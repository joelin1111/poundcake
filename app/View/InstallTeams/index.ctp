...
<div class="span9">
	...
	<tr>
            <td class="index-item"><?php echo $this->Html->link($team['InstallTeam']['name'], array('action' => 'view', $team['InstallTeam']['id'])); ?></td>
            <td class="index-item"><?php echo $team['Project']['name']; ?></td>
