...
<div class="span3">
    ...
    <ul>
        <li><?php echo $this->PoundcakeHTML->link('New SNMP Version', array('action' => 'add')); ?></li>
...
<div class="span9">
	...
	<tr>
            <td class="index-item"><?php echo $item['SnmpType']['name'];?></td>
            <td class="index-action">
            <?php
                echo $this->PoundcakeHTML->link('Edit', array('action' => 'edit', $item['SnmpType']['id']));
                echo '&nbsp;';
