...
<P>
    This version of overview map uses the Marc Fernandez map helper, version 2.0
</P>
<P>
<?php
    ...
    $markerOptions= array(
        ...
        'latitude' => -5.29966 ,		// latitude of the marker
        'longitude' => 39.67422,		//Longitude of the marker
       ...
       foreach ($schools as $school) {
           ...
           */
           ...
           $link = "http://" . $_SERVER['HTTP_HOST'] ."/schools/view/" . $school['School']['id'];
            ...
            $windowText = $primary_school."<br><A HREF=\"".$link."\">School Detail</A>";
            //echo $link;
           // See all options:
